...
void USoundSubsystem::Initialize(FSubsystemCollectionBase& Collection)
{
    ...
    // Config에서 지정한 경로로 사운드 데이터 테이블을 로드합니다.
    if (!SoundDataTablePath.IsNull())
    {
